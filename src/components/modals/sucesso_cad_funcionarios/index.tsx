...
interface ModalSucessoCadFuncionariosProps {
    isOpen: boolean;
    onClose?: () => void;
}

const ModalSucessoCadAlojamento: React.FC<ModalSucessoCadFuncionariosProps> = ({ isOpen, onClose }) => {
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#000000AA]">
            <div className="bg-blue-primary rounded-2xl p-10 flex flex-col items-center w-[400px] max-w-[90vw] shadow-2xl relative">
                ...
                <div className="text-white text-2xl text-center mb-8 font-normal">
                    O cadastro do funcionario foi<br />feito com sucesso
                </div>
